...
class customerController extends Controller
{
    ...
    {
            $customersres = customer::join('country', 'customers.country_id', '=', 'country.id')
    ...
    public function index(Request $request)
    {
        ...
        $customersres = $this->customerModel::join($this->masterdbname . '.country', 'customers.country_id', '=', $this->masterdbname . '.country.id')
