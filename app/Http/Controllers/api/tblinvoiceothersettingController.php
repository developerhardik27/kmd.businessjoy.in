...
use App\Models\invoice_terms_and_condition;
...
class tblinvoiceothersettingController extends commonController
{
    ...
    public function getoverduedays(Request $request)
    {
        ...
        $overdueday = invoice_other_setting::where('is_deleted', 0)->get();
    ...
    public function termsandconditionsindex(Request $request)
    {
        ...
        $termsandcondition = invoice_terms_and_condition::where('is_deleted', 0)->get();
    ...
    public function overduedayupdate(Request $request, string $id)
    {
        ...
        if ($validator->fails()) {
            ...
            $overdueday = invoice_other_setting::find($id);
    ...
    public function invoicetcstore(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $overdue = invoice_terms_and_condition::create([
    ...
    public function tcedit(string $id)
    {
        ...
        $termsandcondition = invoice_terms_and_condition::find($id);
