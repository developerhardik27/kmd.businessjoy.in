...
class PdfController extends Controller
{
   ...
   public function __construct()
   {
      ...
      if (isset($_SESSION['folder_name'])) {
         ...
         $this->invoiceModel = 'App\\Models\\v4_0_0\\invoice';
         $this->paymentdetailsModel = 'App\\Models\\v4_0_0\\payment_details';
         $this->quotationModel = 'App\\Models\\v4_0_0\\quotation';
         $this->consignor_copyModel = 'App\\Models\\v4_0_0\\consignor_copyM';
      }
   ...
   public function generateconsignorcopypdf(int $id)
   {
      ...
      $pdfname = $consignercopydata['data']['consignorcopy']['container_no'] . ' ' . date('d-M-y') . '.pdf';
