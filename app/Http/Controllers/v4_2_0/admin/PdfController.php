...
class PdfController extends Controller
{
   ...
   public function __construct()
   {
      ...
      if (isset($_SESSION['folder_name'])) {
         ...
         $this->invoiceModel = 'App\\Models\\v4_2_0\\invoice';
         $this->paymentdetailsModel = 'App\\Models\\v4_2_0\\payment_details';
         $this->quotationModel = 'App\\Models\\v4_2_0\\quotation';
         $this->consignor_copyModel = 'App\\Models\\v4_2_0\\consignor_copyM';
      }
   }
