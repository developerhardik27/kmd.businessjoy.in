        ...
        if ($validator->fails()) {
            ...
            if ($request->hasFile('attachment')) {
                ...
                foreach ($request->file('attachment') as $attachment) {
                    ...
                    $dirPath = public_path('uploads/') . $this->companyId . '/techsupport/' . $techsupport->id;
                    ...
                    if ($attachment->move($dirPath, $attachmentname)) {
                        $attachments[] = $this->companyId . '/techsupport/' . $techsupport->id . '/' . $attachmentname;
                    }
                }

                $techsupport->attachment = json_encode($attachments); // Store as JSON or any format you prefer
                $techsupport->save();
            }
