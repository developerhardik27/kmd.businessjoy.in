...
class consigneeController extends commonController
{
    ...
    public $userId, $companyId, $masterdbname, $rp, $consigneeModel, $logistic_settingsModel;
    ...
    {
        $customers = $this->consigneeModel::where('customers.is_deleted', 0)->where('customers.customer_type', 'consignee');
        ...
        return $this->successresponse(200, 'consignee', $customers);
    }
    ...
    public function index(Request $request)
    {
       ...
       array_push($dropdown, 'consignee');
       //dd($dropdown);
        $customers = $this->consigneeModel::leftjoin($this->masterdbname . '.country', 'customers.country_id', '=', $this->masterdbname . '.country.id')
