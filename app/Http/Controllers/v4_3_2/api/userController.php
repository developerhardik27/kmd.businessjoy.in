...
class userController extends commonController
{
    ...
    private $modulesConfig = [
        ...
        "developermodule" => [
            ...
            "queues" => ["show", "add", "view", "edit", "delete", "alldata"]

        ],
        "hrmodule" => [
            "hrdashboard" => ["show", "add", "view", "edit", "delete", "alldata"],
            "employees" => ["show", "add", "view", "edit", "delete", "alldata"],
            "companiesholidays" => ["show", "add", "view", "edit", "delete", "alldata"],
            "letters" => ["show", "add", "view", "edit", "delete", "alldata"],
        ],
        "teamodule" => [
            "teadashboard" => ["show", "add", "view", "edit", "delete", "alldata"],
            "companymaster" => ["show", "add", "view", "edit", "delete", "alldata"],
            "garden" => ["show", "add", "view", "edit", "delete", "alldata"],
            "party" => ["show", "add", "view", "edit", "delete", "alldata"],
            "order" => ["show", "add", "view", "edit", "delete", "alldata"],
            "grade" => ["show", "add", "view", "edit", "delete", "alldata"],
            "brokerpurchase" => ["show", "add", "view", "edit", "delete", "alldata"],
            "brokeragebill" => ["show", "add", "view", "edit", "delete", "alldata"],
        ]
    ...
    public function index(Request $request)
    {
        ...
        $usersres = DB::table('users')
            ...
            ->select('users.id', 'users.user_login', 'users.firstname', 'users.lastname', 'users.email', 'users.password', 'users.contact_no', 'country.country_name', 'state.state_name', 'city.city_name', 'users.pincode', 'company_details.name as company_name', 'user_role.role as user_role', 'users.img', 'users.created_by', 'creator.firstname as creator_firstname', 'creator.lastname as creator_lastname', DB::raw("DATE_FORMAT(users.created_at, '%d-%M-%Y %h:%i %p')as created_at_formatted"), 'users.updated_by', 'users.is_active')
            ->where('users.is_deleted', 0);
