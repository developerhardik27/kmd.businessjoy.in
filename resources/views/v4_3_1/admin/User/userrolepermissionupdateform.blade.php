...
@section('page_title')
    {{ config('app.name') }} - Edit User Permission Group
@endsection
@section('title')
                                    ...
                                    <tbody id="admincheckboxes">
                                        ...
                                        @if (session('user_permissions.adminmodule.company.edit') == '1' || $user_id == 1)
                                            <tr id="company">
                                                ...
                                                <td> <input type="checkbox" class="clickmenu" data-value='company' id="showcompanymenu"
                            ...
                            <div class="iq-card-body">
                                <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                                    ...
                                    <tbody id="quotationcheckboxes">
                                        ...
                                        <tr>
                                            <td class="p-0" style="border-right: 0;"> <span class="btn expandsettingsbutton"
                            ...
                            <div class="iq-card-body">
                                <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                                    <thead>
                                        <tr>
                                            <th colspan="7" class="text-right"><b>Select All </b> <input type="checkbox"
                                                    id="blogallcheck" data-module="blog" class="allcheck"></th>
                                        </tr>
                                        <tr>
                                            <th scope="col">Menus</th>
                                            <th scope="col" style="width:15%">Show/Hide</th>
                ...
                success: function (response) {
                    ...
                    if (response.status == 200 && response.userrolepermission != '') {
                        ...
                        if (userrolepermission.role_permissions) {
                            rp = JSON.parse(response.userrolepermission
