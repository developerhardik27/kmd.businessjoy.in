                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" style="font-size: 12px;">
                        <tr>
                            <td width="33%" style="text-align:left; vertical-align:middle;">
                                ...
                                <img src="{{ public_path('uploads/' . $companydetails['company_id']) . '/' . $safeName . '.png' }}"
                        ...
                        <tr>
                            <td style="width: 50%;padding:0;vertical-align:top">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td style="padding-left:10px">
                                            {{ $companydetails['contact_no'] }} @if($companydetails['alternative_number'] != null && $companydetails['alternative_number'] != '') / {{ $companydetails['alternative_number'] }} @endif
                                        </td>
                                    </tr>
                                    @if ($withgst)
                                        <tr>
