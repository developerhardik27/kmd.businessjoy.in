        ...
        <div class="form-group">
            <div class="form-row">
                <div class="col-sm-12">
                    ...
                    <button type="submit" data-toggle="tooltip" data-placement="bottom" data-original-title="Submit Details"
            ...
            ajaxRequest('GET', "{{ route('invoice.bankacc') }}", {
                ...
                if (response.status == 200 && response.bank != '') {
                    ...
                    $.each(response.bank, function (key, value) {
                        ...
                        $('#acc_details').append(`<option ${countrecords === 1 ? 'selected' : ''} value='${value.id}'>${bankdetails}</option>`);
                    });
                } else if (response.status == 500) {
                    Toast.fire({
                        icon: "error",
