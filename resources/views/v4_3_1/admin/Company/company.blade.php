                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                if (row.alternative_number == null || row.alternative_number ==
                                    '') {
                                    alternative_number = '';
                                } else {
                                    alternative_number = ' / ' + row.alternative_number;
                                }
                                return data + alternative_number;
                            }
                        },
                        {
                            data: 'is_active',
                    ...
                    if (company.id == data) {
                        ...
                        $('#details').append(`
                            ...
                            <tr>
                                ...
                                <td>${company.alternative_number || '-'}</td>
                            </tr>
                            <tr>
                                <th>GST Number</th>
                            ...
                            <tr>
                                <th>Logo</th>
                                <td>${company.img ? `<a class='text-primary font-weight-bold' href="/uploads/${company.img}" target='_blank'>Click here</a>` : "Not set yet"}</td>
                            </tr> 
                            <tr>
                                <th>Signature</th>
