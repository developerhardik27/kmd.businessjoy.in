                    ...
                    columns: [
                        ...
                        }, 
                        {
                            ...
                            render: function(data, type, row) {
                                let actionBtns = `
                                    <span>
                                        <button type="button" data-toggle="tooltip" data-placement="bottom" data-original-title="Edit Tag" data-id='${data}'
                                                class="btn edit-btn btn-success btn-rounded btn-sm my-0 mb-2">
                                            <i class="ri-edit-fill"></i>
                                        </button>
                                    </span>
                                    <span>
                                        <button type="button" data-toggle="tooltip" data-placement="bottom" data-original-title="Delete Tag" data-id= '${data}'
