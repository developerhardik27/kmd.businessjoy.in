...
@section('page_title')
    {{ config('app.name') }} - Quotation Manage Columns
@endsection
@section('title')
    Manage Columns
@endsection
    ...
    @isset($message)
        <script>
            $('document').ready(function() {
                alert('Required minimum one column to create quotation. Kindly, Create your columns');
            });
        </script>
    @endisset
    <script>
        $('document').ready(function() {
            ...
            function loaddata() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('quotationcolumn.index') }}",
                    data: {
            ...
            // hide column will be not show into quotation its use for only calculation
            ...
            $('.savecolumnorder').on('click', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('quotationcolumn.columnorder') }}",
                    data: {
                        columnorders,
                        token: "{{ session()->get('api_token') }}",
                        company_id: " {{ session()->get('company_id') }}",
