                                        ...
                                        <tbody id="admincheckboxes">
                                            ...
                                            @if (session('user_permissions.adminmodule.adminapi.add') == '1' || $user_id == 1)
                                                <tr id="adminapi">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu"
                                                            data-value='adminapi' id="showadminapimenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.adminmodule.adminapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showadminapimenu'
                                                                id="viewadminapi" name="viewadminapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.adminmodule.adminapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showadminapimenu'
                                                                id="editadminapi" name="editadminapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.adminmodule.adminapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showadminapimenu'
                                                                id="deleteadminapi" name="deleteadminapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.adminmodule.adminapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showadminapimenu'
                                                                id="alldataadminapi" name="alldataadminapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                            ...
                                            @if (session('user_permissions.quotationmodule.quotationdashboard.add') == '1' || $user_id == 1)
                                                <tr id="quotationdashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationdashboard.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationdashboardmenu' id="addquotationdashboard"
                                                                name="addquotationdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationdashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationdashboardmenu' id="viewquotationdashboard"
                                                                name="viewquotationdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationdashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationdashboardmenu' id="editquotationdashboard"
                                                                name="editquotationdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationdashboardmenu' id="deletequotationdashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationdashboardmenu' id="alldataquotationdashboard"
                                                ...
                                                <tr id="quotationapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationapimenu'
                                                                id="viewquotationapi" name="viewquotationapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationapimenu'
                                                                id="editquotationapi" name="editquotationapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationapimenu'
                                                                id="deletequotationapi" name="deletequotationapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.quotationmodule.quotationapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showquotationapimenu'
                                                                id="alldataquotationapi" name="alldataquotationapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                ...
                                                <tr id="invoicedashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoicedashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoicedashboardmenu' id="viewinvoicedashboard"
                                                                name="viewinvoicedashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoicedashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoicedashboardmenu' id="editinvoicedashboard"
                                                                name="editinvoicedashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoicedashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoicedashboardmenu' id="deleteinvoicedashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoicedashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoicedashboardmenu' id="alldatainvoicedashboard"
                                                ...
                                                <tr id="invoiceapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoiceapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoiceapimenu'
                                                                id="viewinvoiceapi" name="viewinvoiceapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoiceapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoiceapimenu'
                                                                id="editinvoiceapi" name="editinvoiceapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoiceapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoiceapimenu'
                                                                id="deleteinvoiceapi" name="deleteinvoiceapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.invoicemodule.invoiceapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinvoiceapimenu'
                                                                id="alldatainvoiceapi" name="alldatainvoiceapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                        ...
                                        <tbody id="leadcheckboxes">
                                            ...
                                            @if (session('user_permissions.leadmodule.upcomingfollowup.add') == '1' || $user_id == 1)
                                                <tr id="upcomingfollowup">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.upcomingfollowup.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showupcomingfollowupmenu' id="addupcomingfollowup"
                                                                name="addupcomingfollowup" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.upcomingfollowup.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showupcomingfollowupmenu' id="viewupcomingfollowup"
                                                                name="viewupcomingfollowup" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.upcomingfollowup.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showupcomingfollowupmenu' id="editupcomingfollowup"
                                                                name="editupcomingfollowup" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.upcomingfollowup.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showupcomingfollowupmenu' id="deleteupcomingfollowup"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.upcomingfollowup.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showupcomingfollowupmenu' id="alldataupcomingfollowup"
                                                ...
                                                <tr id="recentactivity">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.recentactivity.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showrecentactivitymenu' id="deleterecentactivity"
                                                                name="deleterecentactivity" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.recentactivity.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showrecentactivitymenu' id="alldatarecentactivity"
                                                                name="alldatarecentactivity" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                            ...
                                            @if (session('user_permissions.leadmodule.leadapi.add') == '1' || $user_id == 1)
                                                <tr id="leadapi">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu"
                                                            data-value='leadapi' id="showleadapimenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.leadapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showleadapimenu'
                                                                id="viewleadapi" name="viewleadapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.leadapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showleadapimenu'
                                                                id="editleadapi" name="editleadapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.leadapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showleadapimenu'
                                                                id="deleteleadapi" name="deleteleadapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.leadmodule.leadapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showleadapimenu'
                                                                id="alldataleadapi" name="alldataleadapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                ...
                                                <tr id="customersupportdashboard">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu" data-value='customersupportdashboard'
                                                            id="showcustomersupportdashboardmenu" name="showcustomersupportdashboardmenu" value="1">
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportdashboard.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showcustomersupportdashboardmenu' id="deletecustomersupportdashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showcustomersupportdashboardmenu' id="alldatacustomersupportdashboard"
                                            ...
                                            @if (session('user_permissions.customersupportmodule.customersupportapi.add') == '1' || $user_id == 1)
                                                <tr id="customersupportapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportapi.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showcustomersupportapimenu' id="addcustomersupportapi"
                                                                name="addcustomersupportapi" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showcustomersupportapimenu'
                                                                id="deletecustomersupportapi" name="deletecustomersupportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.customersupportmodule.customersupportapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showcustomersupportapimenu'
                                                                id="alldatacustomersupportapi" name="alldatacustomersupportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                            ...
                                            @if (session('user_permissions.inventorymodule.inventorydashboard.add') == '1' || $user_id == 1)
                                                <tr id="inventorydashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventorydashboard.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventorydashboardmenu' id="addinventorydashboard"
                                                                name="addinventorydashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventorydashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventorydashboardmenu' id="viewinventorydashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventorydashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventorydashboardmenu' id="editinventorydashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventorydashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventorydashboardmenu' id="deleteinventorydashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventorydashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventorydashboardmenu' id="alldatainventorydashboard"
                                                ...
                                                <tr id="inventoryapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventoryapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                ...
                                                                id="viewinventoryapi" name="viewinventoryapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.inventorymodule.inventoryapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showinventoryapimenu'
                                                                id="editinventoryapi" name="editinventoryapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                            ...
                                            @if (session('user_permissions.remindermodule.reminderdashboard.add') == '1' || $user_id == 1)
                                                <tr id="reminderdashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderdashboard.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderdashboardmenu' id="addreminderdashboard"
                                                                name="addreminderdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderdashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderdashboardmenu' id="viewreminderdashboard"
                                                                name="viewreminderdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderdashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderdashboardmenu' id="editreminderdashboard"
                                                                name="editreminderdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderdashboardmenu' id="deletereminderdashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderdashboardmenu' id="alldatareminderdashboard"
                                                ...
                                                <tr id="reminderapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderapimenu'
                                                                id="viewreminderapi" name="viewreminderapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderapimenu'
                                                                id="editreminderapi" name="editreminderapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderapimenu'
                                                                id="deletereminderapi" name="deletereminderapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.remindermodule.reminderapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreminderapimenu'
                                                                id="alldatareminderapi" name="alldatareminderapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                ...
                                                <tr id="reportdashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportdashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportdashboardmenu' id="viewreportdashboard"
                                                                name="viewreportdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportdashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportdashboardmenu' id="editreportdashboard"
                                                                name="editreportdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportdashboardmenu' id="deletereportdashboard"
                                                                name="deletereportdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportdashboardmenu' id="alldatareportdashboard"
                                                ...
                                                <tr id="reportapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportapimenu'
                                                                id="viewreportapi" name="viewreportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportapimenu'
                                                                id="editreportapi" name="editreportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportapimenu'
                                                                id="deletereportapi" name="deletereportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.reportmodule.reportapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showreportapimenu'
                                                                id="alldatareportapi" name="alldatareportapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                        ...
                                        <tbody id="blogcheckboxes">
                                            ...
                                            @if (session('user_permissions.blogmodule.blogapi.add') == '1' || $user_id == 1)
                                                <tr id="blogapi">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu"
                                                            data-value='blogapi' id="showblogapimenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.blogmodule.blogapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showblogapimenu'
                                                                id="viewblogapi" name="viewblogapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.blogmodule.blogapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showblogapimenu'
                                                                id="editblogapi" name="editblogapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.blogmodule.blogapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showblogapimenu'
                                                                id="deleteblogapi" name="deleteblogapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.blogmodule.blogapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showblogapimenu'
                                                                id="alldatablogapi" name="alldatablogapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                            ...
                                            @if (session('user_permissions.logisticmodule.logisticdashboard.add') == '1' || $user_id == 1)
                                                <tr id="logisticdashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticdashboard.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticdashboardmenu' id="addlogisticdashboard"
                                                                name="addlogisticdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticdashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticdashboardmenu' id="viewlogisticdashboard"
                                                                name="viewlogisticdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticdashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticdashboardmenu' id="editlogisticdashboard"
                                                                name="editlogisticdashboard" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticdashboardmenu' id="deletelogisticdashboard"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticdashboardmenu' id="alldatalogisticdashboard"
                                                ...
                                                <tr id="logisticapi">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticapi.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticapimenu'
                                                                id="viewlogisticapi" name="viewlogisticapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticapi.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticapimenu'
                                                                id="editlogisticapi" name="editlogisticapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticapi.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticapimenu'
                                                                id="deletelogisticapi" name="deletelogisticapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.logisticapi.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showlogisticapimenu'
                                                                id="alldatalogisticapi" name="alldatalogisticapi"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                        ...
                                        <tbody id="developercheckboxes"> 
                                            @if (session('user_permissions.developermodule.slowpage.add') == '1' || $user_id == 1)
                                                <tr id="slowpage">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.slowpage.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.slowpage.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.slowpage.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.slowpage.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.slowpage.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                            ...
                                            @if (session('user_permissions.developermodule.errorlog.add') == '1' || $user_id == 1)
                                                <tr id="errorlog">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.errorlog.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.errorlog.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.errorlog.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.errorlog.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.errorlog.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                            ...
                                            @if (session('user_permissions.developermodule.cronjob.add') == '1' || $user_id == 1)
                                                <tr id="cronjob">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.cronjob.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.cronjob.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.cronjob.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.cronjob.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.cronjob.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                            ...
                                            @if (session('user_permissions.developermodule.techdoc.add') == '1' || $user_id == 1)
                                                <tr id="techdoc">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.techdoc.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.techdoc.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.techdoc.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.techdoc.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.techdoc.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                            ...
                                            @if (session('user_permissions.developermodule.versiondoc.add') == '1' || $user_id == 1)
                                                <tr id="versiondoc">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.versiondoc.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.versiondoc.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.versiondoc.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.versiondoc.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.logisticmodule.versiondoc.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
