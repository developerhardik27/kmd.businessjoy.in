...
@section('page_title')
    {{ config('app.name') }} - Update Supplier
@endsection
@section('title')
    Update Supplier
@endsection
            ...
            <div class="form-row">
                <div class="col-sm-12">
                    ...
                    <button type="reset" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Reset supplier Details"
                        class="btn iq-bg-danger float-right mr-2">Reset</button>
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Update supplier Details"
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // get selected supplier data and show it into fields
            ...
            // get & set supplier old data in the form input
            var edit_id = @json($edit_id);
            let supplierSearchUrl = "{{ route('supplier.search', '__editId__') }}".replace('__editId__', edit_id);
            $.ajax({
                type: 'GET',
            ...
            // redirect on supplier list page on click cancel btn
            ...
            $('#supplierupdateform').submit(function(event) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('supplier.update', $edit_id) }}",
                    data: formdata,
                    success: function(response) {
