                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <button type="button" id="adminmodulereset"
                                            class="btn iq-bg-danger float-right resetbtn">Reset</button>
                                        <button type="submit" id="adminmodulesubmit"
                                            class="btn btn-primary float-right my-0 submitBtn">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <button type="button" id="invoicemodulereset"
                                            class="btn iq-bg-danger float-right resetbtn">Reset</button>
                                        <button type="submit" id="invoicemodulsubmit"
                                            class="btn btn-primary float-right my-0 submitBtn">Submit</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <button type="button" id="leadmodulereset"
                                            class="btn iq-bg-danger float-right resetbtn">Reset</button>
                                        <button type="submit" id="leadmodulesubmit"
                                            class="btn btn-primary float-right my-0 submitBtn">Submit</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <button type="button" id="accountmodulereset"
                                            class="btn iq-bg-danger float-right resetbtn">Reset</button>
                    ...
                    <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <button type="button" id="remindermodulereset"
                                            class="btn iq-bg-danger float-right resetbtn">Reset</button>
                                        <button type="submit" id="remindermodulesubmit"
                                            class="btn btn-primary float-right my-0 submitBtn">Submit</button>
                                    </div>
                                </div>
                            </div>
