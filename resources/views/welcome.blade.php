...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="" class="btn btn-primary-gradient rounded-pill py-2 px-4 ms-3 d-none d-lg-block">Start Free
                        Trial</a>
                </div>
            </nav>
                    ...
                    <div class="row">
                        <div class="col-lg-7 text-center text-lg-start">
                            ...
                            <p class="text-white pb-3 animated slideInDown">Make your business process Easy,Effective
                                and Engaging</p>
                            <a href="#contact"
                                class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill me-3 animated slideInLeft">Free Demo</a>
                            <!-- <a href="#contact"
                        ...
                        <div class="col-lg-5 m-0 d-flex justify-content-center justify-content-lg-end wow fadeInUp"
                            data-wow-delay="0.3s">
                            {{-- <div class=""> --}}
                                <img class="img-fluid" src="{{asset('landing/img/2.png')}}" alt="">
                            {{-- </div> --}}
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <a href="#contact" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill mt-3">Yes, I want to remove my business blockages!</a>
                    </div>
                    <div class="col-lg-6">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="{{asset('landing/img/1.png')}}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-4  mock-p-0 ps-0 d-flex justify-content-center justify-content-lg-end wow fadeInUp"
                        data-wow-delay="0.3s">
                        <div class="">
                            <img class="img-fluid" src="{{asset('landing/img/3.png')}}" alt="">
                    ...
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Don't worry! business joy is here to reduce your headache and paperwork. It is
                        ...
                        <p class="mb-4"><i class="fa fa-check text-primary-gradient me-3"></i>Engaging and Clear UI (user Interface) and UX (user experience)</p>
                        <a href="#contact" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill mt-3">Smooth my business process</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Experience unparalleled control and insight into your customer relationships with our CRM's dynamic Account module, centralizing key data to drive precision and efficiency in your business operations such as invoice, quotation, order etc..</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Empower your sales journey with Business Joy's Lead module, a game-changing tool that seamlessly captures, nurtures, and converts leads, ensuring every opportunity is maximized for business growth.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Revolutionize your sales strategy with Sales module, delivering a comprehensive and intuitive platform to streamline pipelines, boost team collaboration, and drive unparalleled success in every deal</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Boost your productivity and stay organized with our software's Task Management module, a powerful tool designed to efficiently plan, execute, and track tasks, ensuring seamless workflow and heightened success for your team<p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Enhance your workforce management with our CRM's Human Resource module, providing a comprehensive solution to streamline HR processes (Leave Management, Payroll Management, Announcements, Employee Documents), foster employee engagement, and cultivate a thriving and productive workplace</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded p-4">
                            ...
                            <p class="m-0">Transform customer interactions into exceptional experiences with our CRM's Customer Support System module, designed to streamline query resolution, enhance communication, and ensure unparalleled satisfaction for lasting customer loyalty.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-5 gx-4 justify-content-center">
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <p class="mb-0">Supercharge your experience by inputting crucial data into our software—it's the key to unlocking unparalleled insights and maximizing your results. Your success begins with the first click—start transforming your data into actionable intelligence now</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <p class="mb-0">Revolutionize your workflow as our user-friendly interface simplifies data processing, slashing your time investment. Streamline tasks effortlessly, empowering you to focus on what matters most while our software efficiently handles the rest.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                            ...
                            <p class="mb-0">Watch your business thrive as our product seamlessly transforms raw data into comprehensive reports, insightful analyses, and tangible results. Harness the power of intelligent data processing to drive strategic decisions and fuel unprecedented growth for your enterprise</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 ps-0  mock-p-0">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="{{asset('landing/img/4.png')}}">
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <p class="mb-4">Fuel your business ambition with our software—the final, least-known pathway to insatiable growth. Feed your hunger for success and let our product be the catalyst for unparalleled prosperity</p>
                        <div class="row g-4">
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <p class="text-center mb-4">Unlock the power of innovation with our cutting-edge software solution. Contact us now to elevate your business with seamless technology integration and unparalleled efficiency</p>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" placeholder="Leave a message here"
                                                id="message" name="msg" style="height: 150px"></textarea>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <img class="w-100" src="{{asset('landing/img/businessjoyfooterlogo.png')}}" alt="businessjoylogo">
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h4 class="text-white mb-4">Address</h4>
                        <p><i class="fa fa-map-marker-alt me-3"></i>India</p>
                        <p><i class="fa fa-phone-alt me-3"></i>+91 9998111874 </p>
                        <p><i class="fa fa-envelope me-3"></i>info@businessjoy.in</p>
                        <div class="d-flex pt-2">
                            <!-- <a class="btn btn-outline-light btn-social" href=""><i class="fab fa-twitter"></i></a> -->
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://www.facebook.com/oceanmnc7/"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://www.instagram.com/oceanmnc/?hl=en"><i class="fab fa-instagram"></i></a>
                            <a class="btn btn-outline-light btn-social" target="_blank" href="https://in.linkedin.com/company/ocean-mnc"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>Raise your inbox with exclusive insights and product updates—subscribe now for a front-row seat to innovation</p>
        ...
        <a id="whatsapp-button" href="https://wa.me/+919998111874?text=I%20am%20Interested%20in%20BusinessJoy" target="_blank">
    ...
    <script>
        alert('your request succesfully submited');
    </script>
@endif
