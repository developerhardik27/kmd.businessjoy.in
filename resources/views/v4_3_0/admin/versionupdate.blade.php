                        ...
                        <div class="iq-card-body">
                            <form id="versioncontrolform" name="versioncontrolform">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select class="form-control" id="version" name="version" required>
                                                ...
                                                <option value="v4_1_0">V4.1.0</option>
                                                <option value="v4_2_0">V4.2.0</option>
                                                <option value="v4_2_1">V4.2.1</option>
                                                <option value="v4_2_2">V4.2.2</option>
                                                <option value="v4_2_3">V4.2.3</option>
                                                <option value="v4_3_0">V4.3.0</option>
                                            </select>
                                ...
                                <div class="alert alert-info">
                                    <p>
                                        <strong>Note: </strong>
                                        Do not upgrade directly to the latest version. First, upgrade to the current
                                        version, then move to the next version step by step until you reach the latest
                                        version. Start by upgrading the Super Admin account first, and only after that,
                                        proceed to upgrade other company accounts.
                                    </p>
                                </div>
                            </form>
                        </div>
