...
@section('page_title')
    {{ config('app.name') }} - Add New Supplier
@endsection
@section('title')
    New Supplier
@endsection
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Save supplier Details" class="btn btn-primary float-right my-0">Save</button>
                </div>
            </div>
        </div>
    </form>
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            window.location.href =
                                "{{ route('admin.supplier') }}"; // redirect on supplier list page
