                            ...
                            <div class="form-row">
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <input type="text" id="modal_firstname"
                                        class="form-control consigneewithoutgstinput" name='firstname'
                                ...
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <input type="text" id="modal_company_name"
                                        class="form-control consigneewithgstinput" name='company_name' id=""
                            ...
                            <div class="form-row">
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <label for="modal_firstname">FirstName</label><span class="consignorwithoutgstspan"
                                        style="color:red;">*</span>
                                    <input type="text" id="modal_firstname"
                                        class="form-control consignorwithoutgstinput" name='firstname'
                                        placeholder="First Name" required>
                                    <span class="modal_error-msg" id="modal_error-firstname" style="color: red"></span>
                                </div>
                                ...
                                <div class="col-sm-6 mb-2">
                                    ...
                                    <input type="text" id="modal_company_name"
                                        class="form-control consignorwithgstinput" name='company_name' id=""
                                        placeholder="Company Name">
                                    <span class="modal_error-msg" id="modal_error-company_name"
                                        style="color: red"></span>
                                </div>
    ...
    <script>
        $('document').ready(function() {
            ...
            function getlogisticothersettings() {
                loadershow();
                ajaxRequest('GET', "{{ route('getlogisticothersettings') }}", {
                    token: API_TOKEN,
                    company_id: COMPANY_ID,
                    user_id: USER_ID
                }).done(function(response) {
