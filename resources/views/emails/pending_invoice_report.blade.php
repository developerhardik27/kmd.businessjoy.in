...
<head>
    ...
    <title>Pending Invoice Report</title>
    <style type="text/css">
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background: linear-gradient(135deg, #97271f 0%, #253566 100%); padding: 40px 20px;">
    ...
    <div class="wrapper">
        ...
        <div class="body-pad">
            <div class="details-card">
                ...
                <table>
                    ...
                    <tr>
                        <td class="key">Invoice Status</td>
                        <td class="val">{{ $invoiceStatus ?? 'All' }}</td>
                    </tr>
                    <tr>
                        <td class="key">Sample Date Range</td>
                        <td class="val">{{ $sampleDateFrom ?? 'All' }} — {{ $sampleDateTo ?? 'All' }}</td>
                    </tr>
                    <tr>
        ...
        <div class="section-pad">
            <p class="section-label">Pending Invoice Data</p>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row['grades'] ?? '-' }}</td>
                            <td class="center">
                                @php $status = strtolower($row['invoice_status'] ?? ''); @endphp
                                @if($status === 'pending')
                                    <span class="badge badge-pending">Pending</span>
                                @elseif($status === 'half invoice')
                                    <span class="badge badge-half">Half Invoice</span>
                                @else
                                    <span class="badge badge-created">Invoices Created</span>
                                @endif
                            </td>
                            <td class="center">{{ $row['sample_status'] ?? '-' }}</td>
        ...
        <div class="footer-msg">
            <p>Please find the pending invoice details above.<br>
