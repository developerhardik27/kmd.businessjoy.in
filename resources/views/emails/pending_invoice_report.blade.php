...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background: linear-gradient(135deg, #97271f 0%, #253566 100%); padding: 40px 20px;">
    ...
    <div class="wrapper">
        ...
        <div class="title-bar">
            ...
            <p>Selected invoice details for your review</p>
        </div>
        {{-- DATA TABLE --}}
        @if(!empty($reportData))
        ...
        <div class="footer-msg">
            <p>Please find the selected pending invoice details above for your review.<br>
            If you have any questions regarding these invoices, please contact us.<br>
