...
@section('page_title')
    {{ config('app.name') }} - Add New Consignee
@endsection
@section('title')
    New Consignee
@endsection
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Save Consignee Details" class="btn btn-primary float-right my-0">Save</button>
                </div>
            </div>
        </div>
    </form>
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            window.location.href =
                                "{{ route('admin.consignee') }}"; // redirect on consignee list page
