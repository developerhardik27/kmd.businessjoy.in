...
@section('page_title')
    {{ config('app.name') }} - Update Consignor
@endsection
@section('title')
    Update Consignor
@endsection
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Update Consignor Details"
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // get & set consignor old data in the form input
            var edit_id = @json($edit_id);
            let consignorSearchUrl = "{{ route('consignor.search', '__editId__') }}".replace('__editId__', edit_id);
            $.ajax({
                type: 'GET',
                url: consignorSearchUrl,
                data: {
                    token: "{{ session()->get('api_token') }}",
            ...
            // subimt form
            $('#consignorupdateform').submit(function(event) {
                ...
                $.ajax({
                    type: 'PUT',
                    url: "{{ route('consignor.update', $edit_id) }}",
                    data: formdata,
                    success: function(response) {
