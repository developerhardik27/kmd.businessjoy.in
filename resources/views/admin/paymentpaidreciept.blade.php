                ...
                <td colspan="2" style="text-align: ">
                    <table width='100%' border="1px solid" cellspacing=0 cellpadding=0>
                        ...
                        <tr>
                            ...
                            <td>{{ $paymentdetail['amount'] }}.00 Rs</td>
                        </tr>
