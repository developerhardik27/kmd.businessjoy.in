...
@section('form-content')
    <form id="userupdateform">
        ...
        <div class="button-container">
            ...
            <button type="reset" class="btn iq-bg-danger resetbtn">Reset</button>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                            ...
                            <tbody>
                                <tr>
                                    <td> <input type="checkbox" id="showinvoicemenu" name="showinvoicemenu"
                                            value="1"></td>
                                    <td>Invoice</td>
                                    ...
                                    <td><input type="checkbox" id="deleteinvoice" name="deleteinvoice" value="1">
                                    </td>
                                </tr>
                                <tr>
                                    <td> <input type="checkbox" id="showcompanymenu" name="showcompanymenu"
                                            value="1"></td>
                                    <td>Company</td>
                                    ...
                                    <td><input type="checkbox" id="deletecompany" name="deletecompany" value="1">
                                    </td>
                                </tr>
                                <tr>
                                    <td> <input type="checkbox" id="showbankmenu" name="showbankmenu" value="1">
                                    </td>
                                    <td>Bank</td>
                                ...
                                <tr>
                                    <td> <input type="checkbox" id="showusermenu" name="showusermenu" value="1">
                                    </td>
                                    <td>User</td>
                                ...
                                <tr>
                                    <td> <input type="checkbox" id="showcustomermenu" name="showcustomermenu"
                                            value="1"></td>
                                    <td>Customer</td>
                                    <td><input type="checkbox" id="addcustomer" name="addcustomer" value="1"></td>
                                    <td><input type="checkbox" id="viewcustomer" name="viewcustomer" value="1">
                                    </td>
                                    <td><input type="checkbox" id="editcustomer" name="editcustomer" value="1">
                                    </td>
                                    <td><input type="checkbox" id="deletecustomer" name="deletecustomer" value="1">
                                    </td>
                                </tr>
                                <tr>
                                    <td> <input type="checkbox" id="showproductmenu" name="showproductmenu"
                                            value="1"></td>
                                    <td>Product</td>
                                    ...
                                    <td><input type="checkbox" id="deleteproduct" name="deleteproduct" value="1">
                                    </td>
                                </tr>
                                <tr>
                                    <td> <input type="checkbox" id="showpurchasemenu" name="showpurchasemenu"
                                            value="1"></td>
                                    <td>Purchase</td>
                                    <td><input type="checkbox" id="addpurchase" name="addpurchase" value="1"></td>
                                    <td><input type="checkbox" id="viewpurchase" name="viewpurchase" value="1">
                                    </td>
                                    <td><input type="checkbox" id="editpurchase" name="editpurchase" value="1">
                                    </td>
                                    <td><input type="checkbox" id="deletepurchase" name="deletepurchase" value="1">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                            ...
                            <tbody>
                                <tr>
                                    <td> <input type="checkbox" id="showleadmenu" name="showleadmenu" value="1">
                                    </td>
                                    <td>Lead</td>
