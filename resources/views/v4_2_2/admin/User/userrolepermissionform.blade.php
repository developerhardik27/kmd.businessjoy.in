                                        ...
                                        @if (session('user_permissions.blogmodule.blogsettings.add') == '1' || $user_id == 1)
                                            <tr id="blogsettings">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.blogmodule.blogsettings.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showblogsettingsmenu' id="addblogsettings" name="addblogsettings"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.blogmodule.blogsettings.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showblogsettingsmenu' id="viewblogsettings" name="viewblogsettings"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.blogmodule.blogsettings.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showblogsettingsmenu' id="editblogsettings" name="editblogsettings"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
