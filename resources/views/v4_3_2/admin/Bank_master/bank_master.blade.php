    ...
    <script>
        $('document').ready(function() {
            ...
            function changebankstatus(bankid, statusvalue) {
                let bankDetailsUpdateUrl = "{{ route('bank_detail.update', '__bankId__') }}".replace('__bankId__', bankid);
            ...
            $(document).on("click", ".del-btn", function() {
                ...
                let bankDetailsDeleteUrl = "{{ route('bank_detail.delete', '__deleteId__') }}".replace(
