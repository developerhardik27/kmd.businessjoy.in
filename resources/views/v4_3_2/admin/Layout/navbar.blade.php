                        ...
                        <ul id="topbar-data-icon" class="d-flex p-0 topbar-menu-icon">
                            <li class="nav-item">
                                <a href="{{ route('admin.index') }}"
                                    ...
                                    <i class="ri-home-4-line" data-toggle="tooltip" data-placement="bottom"
                                ...
                                @if (session('user_permissions.invoicemodule.invoice.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.invoice') }}" class="nav-link">
                                            <i class="ri-file-list-line" data-toggle="tooltip" data-placement="bottom"
                                ...
                                @if (session('user_permissions.invoicemodule.bank.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.bank') }}" class="nav-link">
                                            <i class="ri-bank-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Bank Account List"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.invoicemodule.customer.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.invoicecustomer') }}" class="nav-link">
                                            <i class="ri-group-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Customers List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.inventorymodule.product.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.product') }}" class="nav-link">
                                            <i class="ri-product-hunt-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Products List"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.inventorymodule.purchase.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.purchase') }}"
                                            ...
                                            <i class="ri-bank-card-2-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Purchases List" title="Purchases List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.quotationmodule.quotation.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.quotation') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-file-list-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Qoutation List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.leadmodule.lead.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.lead') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-globe-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Leads List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.customersupportmodule.customersupport.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.customersupport') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-customer-service-line" data-toggle="tooltip"
                                                data-placement="bottom"
                                                data-original-title="Customer Support Complain List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.adminmodule.company.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.company') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-government-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Companies List"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.adminmodule.user.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.user') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-user-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Users List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.remindermodule.reminder.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.reminder') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-alarm-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Reminders List"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.remindermodule.remindercustomer.show') == 1)
                                    <li>
                                        <a href="{{ route('admin.remindercustomer') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-customer-service-2-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Customers List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                            @if (session('menu') == 'logistic')
                                @if (session('user_permissions.logisticmodule.consignorcopy.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.consignorcopy') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-clipboard-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="LR Copy List"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                                ...
                                @if (session('user_permissions.hrmodule.employees.show') == '1')
                                    <li>
                                        ...
                                        <a href="{{ route('admin.employee') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-user-3-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Employee List"></i>
                                        </a>

                                    </li>
                                @endif
                                @if (session('user_permissions.hrmodule.companiesholidays.show') == '1')
                                    <li>
                                        {{-- {{ route('admin.companiesholidays') }} --}}
                                        <a href="{{ route('admin.companiesholidays') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-calendar-event-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Companies Holidays"></i>
                                        </a>

                                    </li>
                                @endif
                                @if (session('user_permissions.hrmodule.letters.show') == '1')
                                    <li>
                                        {{-- {{ route('admin.letter') }} --}}
                                        <a href="{{ route('admin.letter') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-mail-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="letters"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.teamodule.order.show') == '1')
                                    <li>
                                        ...
                                        <a href="{{ route('admin.order') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-shopping-cart-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Order List"></i>
                                        </a>
                                    </li>
                                @endif
                    ...
                    <div class="iq-menu-bt align-self-center">
                        <div class="wrapper-menu">
                            <div class="main-circle">
                                <i class="ri-menu-fill" data-toggle="tooltip" data-placement="bottom"
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="iq-sub-dropdown">
                                        ...
                                        @if (Session::has('hr') && Session::get('hr') == 'yes')
                                            <a class="iq-sub-card changemenu" href="#" data-value="hr">
                                                <i class="ri-article-line"></i> HR</a>
                                        @endif
                                        @if (Session::has('tea') && Session::get('tea') == 'yes')
                                            <a class="iq-sub-card changemenu" href="#" data-value="tea">
                                                <i class="ri-cup-line"></i> Tea</a>
                                        @endif
                                        ...
                                        <div class="d-inline-block w-100 text-center p-3">
                                            @if (session('user_permissions.adminmodule.techsupport.show') == '1')
                                                <a style="color: white !important"
                                                    ...
                                                    href=" {{ route('admin.techsupport') }}" role="button">
