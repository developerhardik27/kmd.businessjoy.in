...
<head>
    ...
    <title>{{ config('app.name') }} - Pending Sample Purchase Report</title>
    <style>
        @page {
            margin: 30px;
        }
...
<body>
    <div class="report-header">
        <div class="report-title">Pending Sample Purchase Report</div>
    ...
    @if(request()->filter_order_date_from || request()->filter_order_date_to || request()->filter_sample_status || request()->filter_company || request()->filter_buyer || request()->filter_sample_date_from || request()->filter_sample_date_to)
    <div class="filters-section">
        ...
        @if(request()->filter_sample_status) | Sample Status: {{ request()->filter_sample_status }} @endif
