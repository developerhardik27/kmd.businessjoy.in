...
@endsection
@if (session('user_permissions.teamodule.garden.add') == '1')
    @section('addnew')
        {{ route('admin.gardenform') }}
    @endsection
    @section('addnewbutton')
        <button data-toggle="tooltip" data-placement="bottom" data-original-title="Add New garden"
    ...
    <script>
        $('document').ready(function() {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                let actionBtns = '';
                                @if (session('user_permissions.teamodule.garden.view') == '1')
                                    actionBtns += `   
                                    ...
                                    `;
                                @endif
                                @if (session('user_permissions.teamodule.garden.edit') == '1')
                                    let editUrl =
                                        `{{ route('admin.gardenupdateform', '__id__') }}`
                                        .replace(
                                            '__id__', data);
                                    actionBtns += `
                                ...
                                @if (session('user_permissions.teamodule.garden.delete') == '1')
                                    actionBtns += `
            ...
            $(document).on("click", ".view-btn", function() {
                ...
                $.each(global_response.data, function(key, garden) {
                    if (garden.id == data) {
                        ...
                        <tr>
                         ...
                         <tr>
                            <th>Contact Person Name</th>
                            <td>${garden.contact_person_name|| '-'}</td>
                        </tr>
                         <tr>
                            <th>Mobile</th>
                            <td>${garden.mobile_1 +' / ' + garden.mobile_2|| '-'}</td>
                        </tr>
                         <tr>
                            <th>Address</th>
            ...
            $(document).on("click", ".del-btn", function() {
                ...
                showConfirmationDialog(
                    ...
                    () => {
                        // Success callback
                        loadershow();
                        let gardenDeleteUrl = "{{ route('garden.delete', '__deleteId__') }}"
                            .replace(
