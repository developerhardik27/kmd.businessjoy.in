                        ...
                        <td style="padding-left:10px; ">
                            <b>
                                ...
                                @isset($data['invoice']['from_date'])
                                    {{ $data['invoice']['from_date'] ? \Carbon\Carbon::parse( $data['invoice']['from_date'])->format('d-m-Y') : '-' }}
                                @endisset
                                to
                                @isset($data['invoice']['to_date'])
                                    {{  $data['invoice']['to_date'] ? \Carbon\Carbon::parse( $data['invoice']['to_date'])->format('d-m-Y') : '-'  }}
                                @endisset
                            </b>
