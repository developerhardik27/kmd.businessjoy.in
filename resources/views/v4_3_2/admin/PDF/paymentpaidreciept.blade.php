    ...
    <div class="container">
        <table width='100%' class="maintable" cellspacing=0 cellpadding=0>
            <tr>
                ...
                <td valign=top class="default" style="width:33%;">
                    <span class="textblue firstrow cname default"
                        style="display:block;">{{ $companydetails['company_name'] }}</span>
                    ...
                    @endisset
                    <span class="default" style="display:block;">Contact: {{ $companydetails['mobile_1'] }}</span>
                </td>
                <td style="vertical-align: top;width:33%;">
            ...
            <tr>
                <td colspan="2" style="vertical-align: top">
                    <span class="default textblue firstrow cname" style="display:block;" id="">Buyer</span>
                ...
                <td colspan="2" style="vertical-align: top">
                    ...
                    @endif --}}
                    @isset($transportdetails['address'])
                        <span class="default" style="display:block;">{!! nl2br(e(wordwrap($transportdetails['address'], 40, "\n", true))) !!}</span>
                    @endisset
                    <span class="default" style="display:block;">
        ...
        <table width='100%' class="maintable" cellspacing=0 cellpadding=0>
            <tr>
                <td colspan="2">
                    <div style="display: inline-block;">
                        For : {{ $companydetails['company_name'] }}
                    </div>
                </td>
            </tr>
            <tr>
