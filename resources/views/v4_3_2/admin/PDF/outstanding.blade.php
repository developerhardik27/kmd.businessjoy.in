    ...
    @foreach ($list as $invoice)
        <div class="invoice-box">
            ...
            <table class="payment-table">
                ...
                <tbody>
                    @php
                        $payments = collect($invoice['details'] ?? [])
                            ->filter(function ($d) {
                                return !empty($d['receipt_number']);
                            })
                            ->values();
                    @endphp
                    ...
                    @else
                        @foreach ($payments as $detail)
                            <tr>
                                ...
                                <td class=" ">{{ formatINR($detail['paid_amount'] ?? 0) }}</td>
                                <td class="text-right ">{{ formatINR($detail['pending_amount'] ?? 0) }}
                                </td>
                            </tr>
                        @endforeach
                    @endif
