                                            ...
                                            <tr id="companiesholidays">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.companiesholidays.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcompaniesholidaysmenu'
                                                            id="deletecompaniesholidays" name="deletecompaniesholidays"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="letters">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='letters'
                                                        id="showlettersmenu" name="showlettersmenu" value="1">
                                                </td>
                                                <td>
                                    ...
                                    <tbody id="teacheckboxes">
                                        @if (session('user_permissions.teamodule.teadashboard.edit') == '1' || $user_id == 1)
                                            <tr id="teadashboard">
                                                <td>Tea Dashboard</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='teadashboard'
                                                        id="showteadashboardmenu" name="showteadashboardmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.teadashboard.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showteadashboardmenu' id="viewteadashboard"
                                                            name="viewteadashboard" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.teadashboard.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showteadashboardmenu' id="editteadashboard"
                                                            name="editteadashboard" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.teadashboard.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showteadashboardmenu' id="deleteteadashboard"
                                                            name="deleteteadashboard" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.teadashboard.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showteadashboardmenu' id="alldatateadashboard"
                                                            name="alldatateadashboard" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                        ...
                                        @if (session('user_permissions.teamodule.companymaster.edit') == '1' || $user_id == 1)
                                            <tr id="companymaster">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='companymaster' id="showcompanymastermenu"
                                                        name="showcompanymastermenu" value="1">
                                                </td>
                                                <td>
                                        ...
                                        @if (session('user_permissions.teamodule.garden.edit') == '1' || $user_id == 1)
                                            <tr id="garden">
                                                <td>Garden</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='garden'
                                                        id="showgardenmenu" name="showgardenmenu" value="1">
                                                </td>
                                                <td>
                                        ...
                                        @if (session('user_permissions.teamodule.party.edit') == '1' || $user_id == 1)
                                            <tr id="party">
                                                <td>Party</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='party'
                                                        id="showpartymenu" name="showpartymenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.party.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpartymenu' id="addparty" name="addparty"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.party.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpartymenu' id="viewparty" name="viewparty"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.party.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpartymenu' id="editparty" name="editparty"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                        ...
                                        @if (session('user_permissions.teamodule.order.edit') == '1' || $user_id == 1)
                                            <tr id="order">
                                                <td>Order</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='order'
                                                        id="showordermenu" name="showordermenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.order.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showordermenu' id="addorder" name="addorder"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.order.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showordermenu' id="vieworder" name="vieworder"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.order.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showordermenu' id="editorder" name="editorder"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.order.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showordermenu' id="deleteorder"
                                                            name="deleteorder" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.order.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showordermenu' id="alldataorder"
                                                            name="alldataorder" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                        ...
                                        @if (session('user_permissions.teamodule.grade.add') == '1' || $user_id == 1)
                                            <tr id="grade">
                                                <td>Grade</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='grade'
                                                        id="showgrademenu" name="showgrademenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.grade.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgrademenu' id="addgrade" name="addgrade"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.grade.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgrademenu' id="viewgrade" name="viewgrade"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.grade.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgrademenu' id="editgrade" name="editgrade"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.teamodule.grade.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgrademenu' id="deletegrade"
                                                            name="deletegrade" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.teamodule.grade.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgrademenu' id="alldatagrade"
                                                            name="alldatagrade" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
