                                                ...
                                                <tr id="hrdashboard">
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.hrdashboard.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showhrdashboardmenu'
                                                                id="viewhrdashboard" name="viewhrdashboard"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.hrdashboard.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showhrdashboardmenu'
                                                                id="edithrdashboard" name="edithrdashboard"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.hrdashboard.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showhrdashboardmenu'
                                                                id="deletehrdashboard" name="deletehrdashboard"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.hrdashboard.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showhrdashboardmenu'
                                                                id="alldatahrdashboard" name="alldatahrdashboard"
                                                                value="1">
                                                        @else
                                                            -
                                                        @endif
                                                ...
                                                <tr id="employees">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu" data-value='employees'
                                                            id="showemployeesmenu" name="showemployeesmenu" value="1">
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.employees.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
