        ...
        @if (session('user_permissions.adminmodule.userpermission.view') == '1' ||
            ...
            <div class="row permission-row">
                <div class="col-sm-12">
                                    ...
                                    <tbody id="invoicecheckboxes">
                                            ...
                                            <tr id="tdsregister">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='tdsregister'
                                                        id="showtdsregistermenu" name="showtdsregistermenu"
                                                        value="1">
                                                </td>
                                                <td>
                                                    NA
                                        ...
                                        @if (session('user_permissions.invoicemodule.invoiceformsetting.edit') == '1' || $user_id == 1)
                                            <tr id="invoiceformsetting"
                                                ...
                                                <td>
                                                    <input type="checkbox"class="clickmenu"
                                                        data-value="invoiceformsetting" id="showinvoiceformsettingmenu"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoiceformsetting.view') == '1' || $user_id == 1)
                                                        <input type="checkbox"class="clicksubmenu"
                                                            data-value="showinvoiceformsettingmenu"
                                                            id="viewinvoiceformsetting" name="viewinvoiceformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoiceformsetting.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox"class="clicksubmenu"
                                                            data-value="showinvoiceformsettingmenu"
                                                            id="editinvoiceformsetting" name="editinvoiceformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="leadsettings">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='leadsettings'
                                                        id="showleadsettingsmenu" name="showleadsettingsmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                    ...
                                    <tbody id="logisticcheckboxes">
                                            ...
                                            <tr id="columnmapping" class="logistic_other_settings_rows subsettingrows">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.inventorymodule.lrcolumnmapping.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showlrcolumnmappingmenu' id="addlrcolumnmapping"
                                                            name="addlrcolumnmapping" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    @if (session('user_permissions.inventorymodule.lrcolumnmapping.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showlrcolumnmappingmenu'
                                                            id="alldatalrcolumnmapping" name="alldatalrcolumnmapping"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                        ...
                                        @if (session('user_permissions.logisticmodule.logisticformsetting.edit') == '1' || $user_id == 1)
                                            <tr id="logisticformsetting"
                                                ...
                                                <td>
                                                    <input type="checkbox"class="clickmenu"
                                                        data-value="logisticformsetting" id="showlogisticformsettingmenu"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.logisticmodule.logisticformsetting.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox"class="clicksubmenu"
                                                            data-value="showlogisticformsettingmenu"
                                                            id="deletelogisticformsetting" name="deletelogisticformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.logisticmodule.downloadcopysetting.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            ...
                                                            id="adddownloadcopysetting" name="adddownloadcopysetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                        ...
                                        @if (session('user_permissions.logisticmodule.transporterbilling.edit') == '1' || $user_id == 1)
                                            <tr id="transporterbilling">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='transporterbilling' id="showtransporterbillingmenu"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.logisticmodule.transporterbilling.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showtransporterbillingmenu'
                                                            id="viewtransporterbilling" name="viewtransporterbilling"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.logisticmodule.transporterbilling.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showtransporterbillingmenu'
                                                            id="edittransporterbilling" name="edittransporterbilling"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                    ...
                                    <tbody id="developercheckboxes">
                                        ...
                                        @if (session('user_permissions.developermodule.automatetest.edit') == '1' || $user_id == 1)
                                            <tr id="automatetest">
                                                <td>Automate Test</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='automatetest'
                                                        id="showautomatetestmenu" name="showautomatetestmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if (session('user_permissions.developermodule.automatetest.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showautomatetestmenu' id="deleteautomatetest"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.developermodule.automatetest.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showautomatetestmenu' id="alldataautomatetest"
                                            ...
                                            <tr id="cleardata">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='cleardata'
                                                        id="showcleardatamenu" name="showcleardatamenu"
                                                        value="1">
                                                </td>
                                                <td>
                                        ...
                                        @endif
                                         @if (session('user_permissions.developermodule.queues.edit') == '1' || $user_id == 1)
                                                <tr id="queues">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu"
                                                            data-value='queues' id="showqueuesmenu"
                                                            name="showqueuesmenu" value="1">
                                                    </td>
                                                    <td>
                                    ...
                                    <tbody id="hrcheckboxes">
                                        @if (session('user_permissions.hrmodule.hrdashboard.edit') == '1' || $user_id == 1)
                                            <tr id="hrdashboard">
                                                <td>HR Dashboard</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='hrdashboard'
                                                        id="showhrdashboardmenu" name="showhrdashboardmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                        ...
                                        @if (session('user_permissions.hrmodule.employees.edit') == '1' || $user_id == 1)
                                            <tr id="employees">
                                                <td>Employees</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='employees'
                                                        id="showemployeesmenu" name="showemployeesmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                        ...
                                        <tr id="companiesholidays">
                                            ...
                                            <td>
                                                <input type="checkbox" class="clickmenu"
                                                    data-value='companiesholidays' id="showcompaniesholidaysmenu"
                                                    name="showcompaniesholidaysmenu" value="1">
                                            </td>
                                            <td>
                                                @if (session('user_permissions.hrmodule.companiesholidays.add') == '1' || $user_id == 1)
                                                    <input type="checkbox" class="clicksubmenu"
                                                        data-value='showcompaniesholidaysmenu' id="addcompaniesholidays"
                                                        name="addcompaniesholidays" value="1">
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td>
                                                @if (session('user_permissions.hrmodule.companiesholidays.view') == '1' || $user_id == 1)
                                                    <input type="checkbox" class="clicksubmenu"
                                                        data-value='showcompaniesholidaysmenu' id="viewcompaniesholidays"
                                                        name="viewcompaniesholidays" value="1">
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td>
                                                @if (session('user_permissions.hrmodule.companiesholidays.edit') == '1' || $user_id == 1)
                                                    <input type="checkbox" class="clicksubmenu"
                                                        data-value='showcompaniesholidaysmenu' id="editcompaniesholidays"
                                                        name="editcompaniesholidays" value="1">
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td>
                                                @if (session('user_permissions.hrmodule.companiesholidays.delete') == '1' || $user_id == 1)
                                                    <input type="checkbox" class="clicksubmenu"
                                                        data-value='showcompaniesholidaysmenu' id="deletecompaniesholidays"
                                            ...
                                            <td>
                                                @if (session('user_permissions.hrmodule.companiesholidays.alldata') == '1' || $user_id == 1)
                                                    <input type="checkbox" class="clicksubmenu"
                                                        data-value='showcompaniesholidaysmenu' id="alldatacompaniesholidays"
                                        ...
                                        <tr id="letters">
                                            ...
                                            <td>
                                                <input type="checkbox" class="clickmenu"
                                                    data-value='letters' id="showlettersmenu"
                                                    name="showlettersmenu" value="1">
                                            </td>
                                            <td>
                    ...
                    @endif
                      @if ((Session::has('tea') && Session::get('tea') == 'yes') || $user_id == 1)
                                            <div class="iq-card">
                                                <div class="iq-card-header d-flex justify-content-between">
                                                    <div class="iq-header-title">
                                                        <h4 class="card-title">Tea Modules</h4>
                                                    </div>
                                                </div>
                                                <div class="iq-card-body">
                                                    <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                                                        <thead>
                                                            <tr>
                                                                <th colspan="7" class="text-right">
                                                                    <b>Select All </b>
                                                                    <input type="checkbox" id="teaallcheck" data-module="tea"
                                                                        class="allcheck">
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <tbody id="teacheckboxes">
                                                            @if (session('user_permissions.teamodule.teadashboard.edit') == '1' || $user_id == 1)
                                                                <tr id="teadashboard">
                                                                    <td>Tea Dashboard</td>
                                                                    <td>
                                                                        <input type="checkbox" class="clickmenu"
                                                                            data-value='teadashboard' id="showteadashboardmenu"
                                                                            name="showteadashboardmenu" value="1">
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.teadashboard.add') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showteadashboardmenu' id="addteadashboard"
                                                                                name="addteadashboard" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.teadashboard.view') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showteadashboardmenu'
                                                                                id="viewteadashboard" name="viewteadashboard"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.teadashboard.edit') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showteadashboardmenu'
                                                                                id="editteadashboard" name="editteadashboard"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.teadashboard.delete') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showteadashboardmenu'
                                                                                id="deleteteadashboard" name="deleteteadashboard"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.teadashboard.alldata') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showteadashboardmenu'
                                                                                id="alldatateadashboard" name="alldatateadashboard"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                            ...
                                                            @endif
                                                            @if (session('user_permissions.teamodule.companymaster.edit') == '1' || $user_id == 1)
                                                                <tr id="companymaster">
                                                                    <td>Company Master</td>
                                                                    <td>
                                                                        <input type="checkbox" class="clickmenu" data-value='companymaster'
                                                                            id="showcompanymastermenu" name="showcompanymastermenu" value="1">
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.companymaster.add') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showcompanymastermenu' id="addcompanymaster"
                                                                                name="addcompanymaster" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.companymaster.view') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showcompanymastermenu' id="viewcompanymaster"
                                                                                name="viewcompanymaster" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.companymaster.edit') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showcompanymastermenu' id="editcompanymaster"
                                                                                name="editcompanymaster" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.companymaster.delete') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showcompanymastermenu' id="deletecompanymaster"
                                                                                name="deletecompanymaster" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.companymaster.alldata') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showcompanymastermenu' id="alldatacompanymaster"
                                                                                name="alldatacompanymaster" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                            ...
                                                            @endif
                                                            @if (session('user_permissions.teamodule.garden.edit') == '1' || $user_id == 1)
                                                            <tr id="garden">
                                                                <td>Garden</td>
                                                                <td>
                                                                    <input type="checkbox" class="clickmenu"
                                                                        data-value='garden' id="showgardenmenu"
                                                                        name="showgardenmenu" value="1">
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.garden.add') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgardenmenu' id="addgarden"
                                                                            name="addgarden" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.garden.view') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgardenmenu' id="viewgarden"
                                                                            name="viewgarden" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.garden.edit') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgardenmenu' id="editgarden"
                                                                            name="editgarden" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.garden.delete') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgardenmenu' id="deletegarden"
                                                                            name="deletegarden" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.garden.alldata') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgardenmenu' id="alldatagarden"
                                                                            name="alldatagarden" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                            ...
                                                            @endif
                                                            @if (session('user_permissions.teamodule.party.edit') == '1' || $user_id == 1)
                                                            <tr id="party">
                                                                <td>Party</td>
                                                                <td>
                                                                    <input type="checkbox" class="clickmenu"
                                                                        data-value='party' id="showpartymenu"
                                                                        name="showpartymenu" value="1">
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.party.add') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showpartymenu' id="addparty"
                                                                            name="addparty" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.party.view') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showpartymenu' id="viewparty"
                                                                            name="viewparty" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.party.edit') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showpartymenu' id="editparty"
                                                                            name="editparty" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.party.delete') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showpartymenu' id="deleteparty"
                                                                            name="deleteparty" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.party.alldata') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showpartymenu' id="alldataparty"
                                                                            name="alldataparty" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                            ...
                                                            @endif
                                                            @if (session('user_permissions.teamodule.order.edit') == '1' || $user_id == 1)
                                                            <tr id="order">
                                                                <td>Order</td>
                                                                <td>
                                                                    <input type="checkbox" class="clickmenu"
                                                                        data-value='order' id="showordermenu"
                                                                        name="showordermenu" value="1">
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.order.add') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showordermenu' id="addorder"
                                                                ...
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.order.view') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showordermenu'
                                                                            id="vieworder" name="vieworder"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                ...
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.order.delete') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showordermenu'
                                                                            id="deleteorder" name="deleteorder"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                ...
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.order.alldata') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showordermenu'
                                                                            id="alldataorder" name="alldataorder"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                            ...
                                                            @endif
                                                            @if (session('user_permissions.teamodule.grade.edit') == '1' || $user_id == 1)
                                                            <tr id="grade">
                                                                <td>Grade</td>
                                                                <td>
                                                                    <input type="checkbox" class="clickmenu"
                                                                        data-value='grade' id="showgrademenu"
                                                                        name="showgrademenu" value="1">
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.grade.add') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgrademenu' id="addgrade"
                                                                            name="addgrade" value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                </td>
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.grade.view') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgrademenu'
                                                                            id="viewgrade" name="viewgrade"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                ...
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.grade.delete') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgrademenu'
                                                                            id="deletegrade" name="deletegrade"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                                ...
                                                                <td>
                                                                    @if (session('user_permissions.teamodule.grade.alldata') == '1' || $user_id == 1)
                                                                        <input type="checkbox" class="clicksubmenu"
                                                                            data-value='showgrademenu'
                                                                            id="alldatagrade" name="alldatagrade"
                                                                            value="1">
                                                                    @else
                                                                        -
                                                                    @endif
                                                            ...
                                                            @endif
                                                             @if (session('user_permissions.teamodule.brokerpurchase.edit') == '1' || $user_id == 1)
                                                                <tr id="brokerpurchase">
                                                                    <td>Broker Purchase</td>
                                                                    <td>
                                                                        <input type="checkbox" class="clickmenu"
                                                                            data-value='brokerpurchase' id="showbrokerpurchasemenu"
                                                                            name="showbrokerpurchasemenu" value="1">
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokerpurchase.add') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokerpurchasemenu' id="addbrokerpurchase"
                                                                                name="addbrokerpurchase" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokerpurchase.view') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokerpurchasemenu'
                                                                                id="viewbrokerpurchase" name="viewbrokerpurchase"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokerpurchase.edit') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokerpurchasemenu'
                                                                                id="editbrokerpurchase" name="editbrokerpurchase"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokerpurchase.delete') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokerpurchasemenu'
                                                                                id="deletebrokerpurchase" name="deletebrokerpurchase"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokerpurchase.alldata') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokerpurchasemenu'
                                                                                id="alldatabrokerpurchase" name="alldatabrokerpurchase"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                            ...
                                                            @endif
                                                             @if (session('user_permissions.teamodule.brokeragebill.edit') == '1' || $user_id == 1)
                                                                <tr id="brokeragebill">
                                                                    <td>Brokerage Bill</td>
                                                                    <td>
                                                                        <input type="checkbox" class="clickmenu"
                                                                            data-value='brokeragebill' id="showbrokeragebillmenu"
                                                                            name="showbrokeragebillmenu" value="1">
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokeragebill.add') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokeragebillmenu' id="addbrokeragebill"
                                                                                name="addbrokeragebill" value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    </td>
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokeragebill.view') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokeragebillmenu'
                                                                                id="viewbrokeragebill" name="viewbrokeragebill"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokeragebill.edit') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokeragebillmenu'
                                                                                id="editbrokeragebill" name="editbrokeragebill"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokeragebill.delete') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokeragebillmenu'
                                                                                id="deletebrokeragebill" name="deletebrokeragebill"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                                    ...
                                                                    <td>
                                                                        @if (session('user_permissions.teamodule.brokeragebill.alldata') == '1' || $user_id == 1)
                                                                            <input type="checkbox" class="clicksubmenu"
                                                                                data-value='showbrokeragebillmenu'
                                                                                id="alldatabrokeragebill" name="alldatabrokeragebill"
                                                                                value="1">
                                                                        @else
                                                                            -
                                                                        @endif
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <button type="button" id="teamodulereset" data-module="tea"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    data-original-title="Reset tea Module"
                                                                    class="btn iq-bg-danger float-right resetbtn mr-2">
                                                                    Reset
                                                                </button>
                                                                <button type="submit" id="teamodulesubmit" data-toggle="tooltip"
                                                                    data-placement="bottom" data-original-title="Save"
                                                                    class="btn btn-primary float-right my-0 submitBtn">
                                                                    Save</button>
                                                            </div>
