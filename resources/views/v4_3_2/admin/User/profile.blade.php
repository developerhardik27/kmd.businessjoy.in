                            ...
                            <div class="tab-pane fade" id="company-profile" role="tabpanel">
                                <div class="iq-card" id="personal_information">
                                    <div class="iq-card-header d-flex justify-content-between">
                                        ...
                                        <div>
                                            <i data-companyid="{{ $company_id }}" id="editicon" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Edit Profile"
                                                class="ri-pencil-fill float-right"></i>
                                    ...
                                    <div class="iq-card-body">
                                        ...
                                        <div class=" row align-items-center">
                                            ...
                                            <div class="form-group col-sm-6" id="god_namesdiv">
                                                <label for="god_names">God Name</label><br>
                                                <p id="god_namesid"></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <form id="defaultpageform" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="homepage" id="homepage" class="form-control"
                                                    ...
                                                    @if (Session::has('tea') && Session::get('tea') == 'yes')
                                                        <optgroup label="tea" data-module="tea">
                                                            @if (session('user_permissions.teamodule.companymaster.show') == '1')
                                                                ...
                                                                @endif
                                                                @if (session('user_permissions.teamodule.party.show') == '1')
                                                    ...
                                                    @if (Session::has('account') && Session::get('account') == 'yes')
                                                        <optgroup label="account" data-module="account">
                                                            @if (session('user_permissions.accountmodule.account.show') == '1')
                                                                <option value="account">Account</option>
                                                            @endif
                                                        </optgroup>
                                                    @endif
                                                    @if (Session::has('logistic') && Session::get('logistic') == 'yes')
                                                        <optgroup label="logistic" data-module="logistic">
                                                            @if (session('user_permissions.logisticmodule.consignorcopy.show') == '1')
                                                                <option value="consignorcopy">Consignor Copy</option>
                                                            @endif
    ...
    <script>
        $('document').ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 200 && response.company != '') {
                        ...
                        $('#companycontact').text(company.contact_no + ' / ' + company
                            .alternative_number);
            ...
            $('#editicon').on('click', function() {
                ...
                let userSearchUrl = "{{ route('user.search', '__editId__') }}".replace('__editId__',
                    edit_id);
                $.ajax({
                    type: 'GET',
                    url: userSearchUrl,
